...
#         if(type(ws) is not WebSocketApp): # This workaround is to solve the websocket_client's compatiblity issue of older versions. ie.0.40.0 which is used in upstox. Now this will work in both 0.40.0 & newer version of websocket_client
#             error = ws
#         if self.__on_error:
...
#         self.__websocket = WebSocketApp(url,
